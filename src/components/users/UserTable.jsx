...
const UserTable = ({
  ...
  const columns = [
      ...
      render: (text, record, index) => (
        <div className="text-center">
          <Badge
            ...
            style={{
              backgroundColor: record.role === "admin" ? "#f5222d" : "#f0f0f0",
              color: record.role === "admin" ? "#fff" : "#666",
              fontSize: "12px",
              fontWeight: "bold",
            }}
          />
    ...
    },
    {
      ...
      fixed: "left",
      render: (record) => (
        <div className={`flex items-center space-x-3 ${record.role === "admin" ? "bg-red-50 p-2 rounded-md" : ""}`}>
          <Avatar
            size={40}
            src={
              record.avatar
            ...
            icon={<UserOutlined />}
            className={`border-2 ${record.role === "admin" ? "border-red-300" : record.role === "moderator" ? "border-green-300" : "border-blue-100"}`}
          />
            ...
            <div className="flex items-center space-x-2">
              <Text
                ...
                className={`cursor-pointer transition-colors hover:text-blue-600 ${
                  record.role === "admin" ? "text-red-600" : "text-gray-800"
                }`}
                onClick={() => {
      ...
      render: (id, record) => (
        <Tooltip title="Click to copy">
          <Text
            code
            copyable={{ text: id }}
            className={`cursor-pointer text-xs ${record.role === "admin" ? "bg-red-50" : ""}`}
          >
      ...
      render: (record) => (
        <div className="text-center">
          <Tag
            ...
            className={`rounded-full px-3 ${record.role === "admin" ? "font-bold" : ""}`}
          >
    ...
    },
    {
      ...
      width: 120,
      render: (date, record) => (
        <div className={`text-center ${record.role === "admin" ? "bg-red-50 p-1 rounded" : ""}`}>
